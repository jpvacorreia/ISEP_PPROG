...
/**
 * Class Seriacao1 utilizada para instanciar um objeto de Seriacao1 para posteriormente
 * ser utilizado como critério de ordenação de uma determinada lista de Candidaturas.
 */
public class Seriacao1 implements Comparator<Candidatura>, Seriavel {
     ...
     * 2º Preço	mais baixo;
     * 3º Candidatura registada mais cedo;
     *
     * @param c1 Candidatura 1
     * @param c2 Candidatura 2
     * return c -1, 0 ou 1 dependendo se c1 deve ser primeiro que c2.
     */
    @Override
   ...
   @Override
    public String toString() {
        return String.format("Seriacao1");
    }
